			...
			try{
				...
				if(result == 0){
					...
					if(to.getFilename() != null && oldFilename != null){
						File file = new File("C:/Java/jsp-workspace/PdsModel2Ex01/WebContent/upload", oldFilename);
						file.delete();
					}
				}
			} catch(SQLException e){
	...
	public int boardDeleteOk(BoardTO to) {
		...
		try{
			...
			if(result == 0){
				...
				flag = 0;
				if(filename != null){
					File file = new File("C:/Java/jsp-workspace/PdsModel2Ex01/WebContent/upload", filename);
					file.delete();
				}
			}
		} catch(SQLException e){
