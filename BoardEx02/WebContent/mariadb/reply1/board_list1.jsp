...
<%
	...
	try{
		...
		String sql = "select seq, grpl, subject, writer, date_format(wdate, '%Y-%m-%d') wdate, hit, datediff(now(), wdate) wgap from rep_board1 order by grp desc, grps asc";	// 최근글을 가장 윗쪽에
		...
		for(int i=0; i<recordPerPage && rs.next(); i++){
			...
			if(grpl != 0){
				sbHtml.append(sgrpl + "<img src='../../images/icon_re.gif' alt='RE'>");
			}
