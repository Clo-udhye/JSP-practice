		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<button class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='board_view1.jsp'">보기</button>
				</div>
				<div class="align_right">
					<button class="btn_write btn_txt01" style="cursor: pointer;">삭제</button>
				</div>
			</div>
			<!--//게시판-->
		</div>
